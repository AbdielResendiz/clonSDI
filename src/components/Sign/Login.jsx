...
import { Checkbox,Select,ScrollView, Column,} from "native-base";
...
const Login= ()=> {
    ...
    const [isShow, setShow]    = useState({vista: 0, status:true})
    useEffect(()=>{
    ...
    return (
        ...
        <View flex={3} bg="white">
         <Center flex={1}>
            ...
            { JSON.stringify(isShow) === JSON.stringify(start) ? (<FormRegistro/>):(null)}  
